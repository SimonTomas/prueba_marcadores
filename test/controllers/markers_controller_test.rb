...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { category_id: @marker.category_id, type_id: @marker.type_id, url_address: @marker.url_address } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { category_id: @marker.category_id, type_id: @marker.type_id, url_address: @marker.url_address } }
